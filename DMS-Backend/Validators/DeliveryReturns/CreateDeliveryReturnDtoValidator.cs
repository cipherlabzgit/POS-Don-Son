...
public class CreateDeliveryReturnDtoValidator : AbstractValidator<CreateDeliveryReturnDto>
{
    public CreateDeliveryReturnDtoValidator()
    {
        ...
        RuleForEach(x => x.Items).SetValidator(new CreateDeliveryReturnItemDtoValidator());
    }
}

public class CreateDeliveryReturnItemDtoValidator : AbstractValidator<CreateDeliveryReturnItemDto>
{
    public CreateDeliveryReturnItemDtoValidator()
    {
