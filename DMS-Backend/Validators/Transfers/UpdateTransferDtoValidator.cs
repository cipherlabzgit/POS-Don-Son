...
public class UpdateTransferDtoValidator : AbstractValidator<UpdateTransferDto>
{
    public UpdateTransferDtoValidator()
    {
        ...
        RuleForEach(x => x.Items).SetValidator(new UpdateTransferItemDtoValidator());
    }
}

public class UpdateTransferItemDtoValidator : AbstractValidator<UpdateTransferItemDto>
{
    public UpdateTransferItemDtoValidator()
    {
