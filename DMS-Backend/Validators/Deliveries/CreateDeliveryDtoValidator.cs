...
public class CreateDeliveryDtoValidator : AbstractValidator<CreateDeliveryDto>
{
    public CreateDeliveryDtoValidator()
    {
        ...
        RuleForEach(x => x.Items).SetValidator(new CreateDeliveryItemDtoValidator());
    }
}

public class CreateDeliveryItemDtoValidator : AbstractValidator<CreateDeliveryItemDto>
{
    public CreateDeliveryItemDtoValidator()
    {
