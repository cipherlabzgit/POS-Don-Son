      ...
      <div className="w-full max-w-lg overflow-hidden rounded-2xl border border-neutral-700 bg-neutral-950 shadow-2xl">
        ...
        {vm.phase === 'locked' ? (
          ...
          >
            ...
            <div className="space-y-3 rounded-lg border border-amber-700/60 bg-amber-950/30 px-3 py-3">
              <div className="flex items-center gap-2 text-white">
                <Monitor className="h-4 w-4 text-amber-400" />
                <p className="text-sm font-bold tracking-wide text-white">Customer display</p>
              </div>
